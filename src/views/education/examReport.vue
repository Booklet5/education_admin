    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button
            size="small"
            @click="examDetail(scope.row)"
            type="warning">分析报告</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getExamReportList () {
        this.axios.get(this.$http.httpUrl('/system/exam/getExamReportList'), {
          params: {
      ...
      examDetail (testPaperInfo) {
        this.$store.commit('map/updateTestPaperInfo', testPaperInfo)
        this.$router.push('examReportDetail')
      }
    },
