...
<script>
  export default {
    ...
    mounted () {
      this.testPaperInfoId = parseInt(this.$store.state.map.testPaperInfoId)
    ...
    methods: {
      ...
      getOnlineExamStudentList () {
        this.axios.get(this.$http.httpUrl('/system/examMonitor/selectByTestPaperInfoId/' + this.testPaperInfoId), {
          params: {
